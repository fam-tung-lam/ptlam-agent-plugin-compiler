...
# The manifest schema version selects the supported plugin data contract. New
# plugins use v2; v1 remains supported for existing hook-free manifests.
schema_version: 2
...
# Hooks are optional in schema v2. Each universal event owns an ordered list of
# authored .mjs handlers whose paths are relative to plugin/hooks/.
# hooks:
#   sessionStart:
