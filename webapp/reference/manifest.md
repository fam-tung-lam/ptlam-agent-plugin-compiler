...
Next: read the [Authored Plugin Source](/reference/authored-source), apply
[visibility and status rules](/guide/skill-graph), or see how fields map into
[provider output](/reference/providers).
